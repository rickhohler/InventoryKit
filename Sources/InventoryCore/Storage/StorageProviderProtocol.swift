...
public protocol StorageProviderProtocol: Sendable {
    ...
    var userMetadata: any UserMetadataStoreProtocol { get }
    ...
    var domainMetadata: any DomainMetadataStoreProtocol { get }
    ...
    var userData: any UserDataStoreProtocol { get }
    ...
    var domainData: any DomainDataStoreProtocol { get }
}
