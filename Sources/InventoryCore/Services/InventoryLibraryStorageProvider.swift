...
///
///     func createProduct(_ product: any InventoryProductProtocol) async throws {
///         // Save to CloudKit public database (shared, not user-specific)
///     }
///
///     func getProduct(id: UUID) async throws -> (any InventoryProductProtocol)? {
...
public protocol InventoryLibraryStorageProvider: Sendable {
    ...
    ///
    /// - Parameter product: The product to create (conforms to InventoryProductProtocol)
    ...
    /// - Returns: The product if found, `nil` otherwise (conforms to InventoryProductProtocol)
    ...
    /// - Returns: Array of matching products (conform to InventoryProductProtocol)
    ...
    func updateProduct(_ product: any InventoryProductProtocol) async throws
    ...
    func createProducts(_ products: [any InventoryProductProtocol]) async throws
    ...
    func updateProducts(_ products: [any InventoryProductProtocol]) async throws
...
extension InventoryLibraryStorageProvider {
    ...
    public func createProducts(_ products: [any InventoryProductProtocol]) async throws {
    ...
    public func updateProducts(_ products: [any InventoryProductProtocol]) async throws {
        for product in products {
