...
public protocol InventoryStorageProvider: Sendable {
    ...
    var vendor: (any InventoryVendorProtocol)? { get }
    ...
    func createVendor(_ vendor: any InventoryVendorProtocol) async throws
    ...
    func saveVendor(_ vendor: any InventoryVendorProtocol) async throws
    ...
    func loadVendor(id: UUID) async throws -> (any InventoryVendorProtocol)?
    
    /// Fetch all vendors from storage.
    ///
    /// - Returns: Array of all vendors
    /// - Throws: `InventoryError` if fetch fails
    func fetchVendors() async throws -> [any InventoryVendorProtocol]
...
extension InventoryStorageProvider {
    ...
    public var vendor: (any InventoryVendorProtocol)? {
        return nil
    }
    
    /// Default implementation that calls `saveInventory(_:)`.
    public func replaceInventory(with document: any InventoryDocumentProtocol) async throws {
    ...
    public func createVendor(_ vendor: any InventoryVendorProtocol) async throws {
        throw InventoryError.vendorOperationNotSupported("Vendor operations are not supported by this storage provider")
    }
    
    /// Default implementation: throws error indicating vendor operations are not supported
    public func saveVendor(_ vendor: any InventoryVendorProtocol) async throws {
        throw InventoryError.vendorOperationNotSupported("Vendor operations are not supported by this storage provider")
    }
    
    /// Default implementation: returns nil (vendor not found)
    public func loadVendor(id: UUID) async throws -> (any InventoryVendorProtocol)? {
        return nil
    }
    
    /// Default implementation: returns empty array
    public func fetchVendors() async throws -> [any InventoryVendorProtocol] {
        return []
    }
