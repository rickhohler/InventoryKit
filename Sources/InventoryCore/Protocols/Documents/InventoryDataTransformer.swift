...
public protocol InventoryDataTransformer: Sendable {
    ...
    func decode(_ data: Data, validatingAgainst version: InventorySchemaVersion) throws -> any InventoryDocument
...
public struct AnyInventoryDataTransformer: InventoryDataTransformer {
    ...
    private let decodeClosure: @Sendable (Data, InventorySchemaVersion) throws -> any InventoryDocument
    private let encodeClosure: @Sendable (any InventoryDocument) throws -> Data
    ...
    public func decode(_ data: Data, validatingAgainst version: InventorySchemaVersion) throws -> any InventoryDocument {
        try decodeClosure(data, version)
    }

    public func encode(_ document: any InventoryDocument) throws -> Data {
