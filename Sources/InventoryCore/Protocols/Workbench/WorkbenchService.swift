...
public protocol WorkbenchService: Sendable {
    ...
    func checkout(assetID: UUID) async throws -> any WorkbenchItem
    ...
    func save(_ item: any WorkbenchItem) async throws
    ...
    func commit(_ item: any WorkbenchItem, as classification: String) async throws -> any InventoryAsset
    
    /// Discards the WorkbenchItem and cleans up temporary files.
    func discard(_ item: any WorkbenchItem) async throws
}
