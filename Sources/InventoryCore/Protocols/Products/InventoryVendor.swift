...
public protocol InventoryVendor: Identifiable, Sendable where ID == UUID {
...
// MARK: - InventoryVendor Default Implementation

public extension InventoryVendor {
