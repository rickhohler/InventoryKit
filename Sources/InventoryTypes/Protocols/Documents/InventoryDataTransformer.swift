...
public struct AnyInventoryDataTransformer: InventoryDataTransformer {
    ...
    private let decodeClosure: @Sendable (Data, SchemaVersion) throws -> any InventoryDocument
    ...
    public func decode(_ data: Data, validatingAgainst version: SchemaVersion) throws -> any InventoryDocument {
