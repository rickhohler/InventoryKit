...
private struct MockTransformer: InventoryDataTransformer {
    ...
    func decode(_ data: Data, validatingAgainst version: InventorySchemaVersion) throws -> any InventoryDocument { throw InventoryError.notImplemented("") }
    func encode(_ document: any InventoryDocument) throws -> Data { return Data() }
}

final class InventoryStorageProviderTests: XCTestCase {
    ...
    func testReplaceInventory() async throws {
        ...
        struct MockDocument: InventoryDocument {
            var schemaVersion: InventorySchemaVersion = .current
...
private struct MinimalVendor: InventoryVendor {
    let id: UUID
    let name: String
}
